...
[Paper](https://arxiv.org/abs/2506.00045) · [PDF](https://arxiv.org/pdf/2506.00045) · [Issues](https://github.com/StaryMoon/ACE-Step-Unofficial/issues) · [Release](https://github.com/StaryMoon/ACE-Step-Unofficial/releases)
...
This repository organizes a PyTorch implementation for **ACE-Step: A Step Towards Music Generation Foundation Model**, focusing on music generation foundation modeling with diffusion, DCAE compression, and controllable audio editing. The codebase is structured like a standard research repository so that model components, configuration files, scripts, and evaluation utilities can be extended independently.
...
```bash
git clone https://github.com/StaryMoon/ACE-Step-Unofficial.git
cd ACE-Step-Unofficial
python -m venv .venv
...
```python
import torch
from ace_step_unofficial import ModelConfig, UnofficialModel, reconstruction_loss

config = ModelConfig(task="audio", hidden_dim=128, num_layers=2, num_heads=4)
...
```python
import torch
from ace_step_unofficial import UnofficialModel
...
|---|---|---|
| Main quantitative comparison | Main paper tables | [arXiv paper](https://arxiv.org/abs/2506.00045) |
| Ablation study | Experiment / ablation sections | [arXiv paper](https://arxiv.org/abs/2506.00045) |
| Qualitative examples | Main paper figures and appendix | [arXiv PDF](https://arxiv.org/pdf/2506.00045) |
...
```bibtex
@article{ACEStep_2025,
  title   = {ACE-Step: A Step Towards Music Generation Foundation Model},
  author  = {Junmin Gong et al.},
...
- Thanks to the authors of **ACE-Step: A Step Towards Music Generation Foundation Model** for the original research.
...
pytorch, unofficial-implementation, reproduction, music-generation, audio, diffusion, foundation-model, ace-step
